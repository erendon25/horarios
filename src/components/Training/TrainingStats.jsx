...
const TrainingStats = ({ onBack, activeArea }) => {
    ...
    return (
        <div className="flex flex-col min-h-[100dvh] bg-slate-50 overflow-y-auto pb-10 sm:pb-20">
            {/* Header */}
            <div className="bg-white p-4 sm:p-8 rounded-b-3xl sm:rounded-b-[50px] shadow-sm border-b border-gray-100 flex items-center gap-3 sm:gap-6">
                <button
                    onClick={onBack}
                    className="shrink-0 p-3 sm:p-4 bg-orange-50 text-orange-600 rounded-xl sm:rounded-2xl hover:bg-orange-100 transition-all active:scale-95"
                >
                    <ArrowLeft size={24} strokeWidth={3} />
                </button>
                <div className="min-w-0">
                    <h1 className="text-xl sm:text-3xl font-black text-gray-900 tracking-tight uppercase leading-tight break-words">
                        Reporte de Entrenamiento
                    </h1>
                    <p className="text-[9px] sm:text-[11px] text-gray-400 font-black uppercase tracking-[0.1em] sm:tracking-[0.2em] mt-1 leading-relaxed">
            ...
            <div className="p-4 sm:p-8 space-y-4 sm:space-y-8 max-w-5xl mx-auto w-full">
                ...
                <div className="bg-white p-4 sm:p-10 rounded-2xl sm:rounded-[48px] shadow-xl sm:shadow-2xl shadow-gray-200/50 border border-white">
                    <div className="flex justify-between items-center mb-5 sm:mb-10">
                        <div className="flex items-center gap-4">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 shrink-0 bg-orange-50 rounded-xl sm:rounded-2xl flex items-center justify-center text-orange-500">
                                <BarChart3 size={24} strokeWidth={3} />
                            </div>
                            <h3 className="text-base sm:text-xl font-bold text-slate-800 tracking-tight leading-tight">Certificaciones por Estación</h3>
                        </div>
                    </div>
                    ...
                    <div className="h-[300px] sm:h-[400px] w-full">
                        {loading ? (
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={stats} margin={{ top: 20, right: 8, left: -20, bottom: 70 }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
                    {/* Top Certified */}
                    <div className="bg-white p-4 sm:p-8 rounded-2xl sm:rounded-[40px] shadow-xl shadow-gray-200/40 border border-gray-50">
                            ...
                            {topCollabs.map((collab, i) => (
                                <div key={i} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl hover:bg-slate-100 transition-all border border-slate-100/50">
                                    <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                                        ...
                                        <span className="text-sm font-bold text-slate-700 break-words">{collab.name}</span>
                                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-gradient-to-br from-orange-500 to-orange-600 p-5 sm:p-8 rounded-2xl sm:rounded-[40px] text-white shadow-2xl shadow-orange-500/30 flex justify-between items-center overflow-hidden relative group">
                        ...
                        <div className="bg-white p-5 sm:p-8 rounded-2xl sm:rounded-[40px] shadow-xl shadow-gray-200/40 border border-gray-100 flex items-center justify-between hover:border-orange-200 transition-all cursor-pointer">
                            <div className="flex items-center gap-4 sm:gap-6 min-w-0">
                                <div className="w-12 h-12 sm:w-14 sm:h-14 shrink-0 bg-gray-50 rounded-2xl flex items-center justify-center text-gray-400">
                                    <Download size={24} />
                                </div>
                                <div>
                                    <h4 className="text-sm sm:text-base font-black text-slate-800 tracking-tight uppercase">Exportar Reporte</h4>
