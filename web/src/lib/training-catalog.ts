export type TrainingPoint = { id: string | number; text: string };
export type TrainingSection = { id: string; title: string; points: TrainingPoint[] };
export type TrainingStation = { title: string; points: TrainingPoint[] };
