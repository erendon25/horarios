-- A prior schedule-lock migration in this worktree recreated the self-service
-- function with direct skill writes. Reassert the deployed invariant after the
-- implementation was moved to `private`: collaborators may update personal
-- fields, but cannot self-certify position abilities.
